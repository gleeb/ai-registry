...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-stories** from `.kilo/skills/planning-stories/` for the story outline template, dependency manifest schema, and planning boundaries (`references/STORY-OUTLINE.md`, `references/DEPENDENCY-MANIFEST.md`, `SKILL.md`).
