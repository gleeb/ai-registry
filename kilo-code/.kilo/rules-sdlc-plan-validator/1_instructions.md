...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-validator** from `.kilo/skills/planning-validator/` for validation dimensions, traceability rules, mode-specific logic, and reference checklists (`references/`, `SKILL.md`).
