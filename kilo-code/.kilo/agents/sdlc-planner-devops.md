...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-devops** from `.kilo/skills/planning-devops/` for templates, patterns, and DevOps reference (`SKILL.md`, `references/DEVOPS-PLAN.md`).
