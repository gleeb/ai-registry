...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-security** from `.kilo/skills/planning-security/` for the security template, sparring protocol, and per-story rules (`references/SECURITY-PLAN.md`, `SKILL.md`).
