...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-design** from `.kilo/skills/planning-design/` for templates, patterns, and design references (`references/UX-DISCOVERY.md`, `references/BRAND-FOUNDATION.md`, `references/DESIGN-SPEC.md`, `references/ACCESSIBILITY-CHECKLIST.md`, `references/DEVELOPER-HANDOFF.md`, mock templates under `references/mock-template/`).
