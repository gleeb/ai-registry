...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-hld** from `.kilo/skills/planning-hld/` for the HLD template, sparring protocol, and per-story rules (`references/HLD.md`, `SKILL.md`).
