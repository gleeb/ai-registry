...
- Skills live under `.kilo/skills/{skill-name}/`. Load **planning-testing-strategy** from `.kilo/skills/planning-testing-strategy/` for workflow detail, templates, and testing reference (`references/ACCESSIBILITY-TESTING.md`, `SKILL.md`).
...
1. **Load planning-testing-strategy skill** — Load from `.kilo/skills/planning-testing-strategy/` for templates, patterns, testing reference, and `references/ACCESSIBILITY-TESTING.md`.
