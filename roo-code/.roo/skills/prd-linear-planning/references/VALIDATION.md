...
**Research dispatch**: When the planner cannot confidently assess technical feasibility, dispatch a `project-research` agent before scoring this dimension. Do not guess.
