...
- **Principle:** Number files to indicate execution order
- **Principle:** Use descriptive names that indicate content
- **Principle:** Keep related instructions together
...
**Description:** Template for main workflow files (1_workflow.xml)
...
**Description:** Template for best practices files (2_best_practices.xml)
...
**Description:** Template for decision criteria and guardrails (4_decision_guidance.xml)
...
**Description:** Template for example files (5_examples.xml)
...
**Description:** Template for communication guidelines (7_communication.xml)
