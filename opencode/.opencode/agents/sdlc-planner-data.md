...
When the data design references specific external libraries, SDKs, frameworks, database technologies, or platform APIs from the tech stack:
...
This ensures data architecture artifacts are grounded in actual library capabilities rather than assumptions that may cause implementation failures downstream.
