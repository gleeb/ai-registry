...
- CLI commands: [references/commands.md](references/commands.md)
- Full API: [references/api.md](references/api.md)
- MCP server: [references/mcp.md](references/mcp.md)
- Minimal env vars: [references/env.md](references/env.md)
- Profile management: [references/profiles.md](references/profiles.md)
- Agent optimization: [references/agent-optimization.md](references/agent-optimization.md)
- Docker environment setup: [references/environment-setup.md](references/environment-setup.md)
- SDLC browser verification protocol: [references/browser-verification-protocol.md](references/browser-verification-protocol.md)
